...
def train(train_data, val_data):
    ...
    for cur_epoch in range(config.epochs_num):
        ...
        for batch_x, batch_y in train_loader:
            optimizer.zero_grad()
            enc_batch, enc_padding_mask, enc_lens, enc_batch_extend_vocab, extra_zeros, c_t_1, coverage = batch_x
            dec_batch, dec_padding_mask, max_dec_len, dec_lens_var, target_batch = batch_y
