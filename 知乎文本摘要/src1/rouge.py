...
# 对于生成摘要和参考摘要分别写进文件的情况，计算平均ROUGE
def load_word_sents(filename):
    """从文件中读取词语和空格连成的句子"""
...
def avg_rouge(ref_dir, dec_dir):
    ...
    for k in keys:
        ...
        for dic in scores_list:
            v += dic[k]
        rouge_score_dic[k] = v / n

    return rouge_score_dic
