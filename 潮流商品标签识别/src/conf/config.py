...
gender_label = ['Men', 'Women', 'Unisex', 'Boys', 'Girls']
master_category = ['Apparel', 'Accessories', 'Footwear', 'Personal Care', 'Free Items', 'Sporting Goods',
                   'Home', 'FootwearBoys']
sports_label = ['Casual', 'Sports', 'Ethnic', 'Formal',
                'Smart Casual', 'Party', 'Travel', 'Home']
