...
#
#================================================================
#todo:python convert_weight.py -cf ./checkpoint/yolov3.ckpt-10000 -nc 70  -ap ./data/plate_anchors.txt --freeze
# python convert_weight.py -cf ./checkpoint/yolov3.ckpt-10000 -nc 1  -ap ./data/plate_anchors.txt --freeze
import os
import sys
import wget
import time
...
class parser(argparse.ArgumentParser):
    ...
    def __init__(self,description):
        ...
        self.add_argument(
            "--anchors_path", "-ap", default="./data_/coco_anchors.txt", type=str,
            help="[default: %(default)s] The path of anchors ...",
            metavar="<AP>",
        )
        # coco_anchors.txt 9个目标框的尺寸
